...
from .reports.guests_vs_bluff import retrieve_bluff_stats, retrieve_not_my_job_stats
...
@blueprint.route("/guests-vs-bluffs")
def guests_vs_bluffs():
    """View: Not My Job Guest Wins vs Bluff the Listener Wins Report"""
    _database_connection = mysql.connector.connect(**current_app.config["database"])
