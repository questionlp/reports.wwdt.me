...
def retrieve_best_of_shows_guest_host_scorekeeper(
    database_connection: MySQLConnection | PooledMySQLConnection,
) -> list[dict[str, Any]]:
    """Retrieve a list of all Best Of shows with a guest host and scorekeeper.
    ...
    query = """
        ...
        sk.scorekeeperslug, skm.guest as scorekeeper_guest,
        l.venue, l.city, l.state
        ...
        AND s.bestof = 1
        AND hm.guest = 1 AND skm.guest = 1
